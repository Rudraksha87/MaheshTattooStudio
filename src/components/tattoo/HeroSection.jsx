...
const slides = [
  {
    src: 'https://media.base44.com/images/public/6a35699540c0f3fcf7294410/3635aa394_WhatsAppImage2026-06-21at103529PM.jpg',
    accent: '#e8a87c',
    label: 'Japanese Sleeve Art',
  },
  {
    src: 'https://media.base44.com/images/public/6a35699540c0f3fcf7294410/c0bfac776_tattoo1.jpg',
    accent: '#d4a96a',
    label: 'Precision in Every Line',
  },
  {
    src: 'https://media.base44.com/images/public/6a35699540c0f3fcf7294410/cf7b76993_tattoo3.jpg',
    accent: '#90caf9',
    label: 'Tribal & Blackwork',
  },
];
  ...
  return (
    <section id="hero" className="relative h-screen overflow-hidden bg-black">
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center px-6 text-center">
        ...
        {/* 2. Slide label — colored, changes with slide, centered between title & paragraph */}
        ...
        >
          Award-winning tattoo artists creating unforgettable body art. Where 40 years of artistic mastery meets the discipline of the needle.
        </motion.p>

        {/* 4. CTA buttons — pushed down a bit */}
        <motion.div
        ...
        >
          ...
          >
            ...
            <motion.div
              ...
              animate={{ boxShadow: ['0 0 25px rgba(193,18,31,0.6)', '0 0 50px rgba(193,18,31,1)', '0 0 25px rgba(193,18,31,0.6)'] }}
